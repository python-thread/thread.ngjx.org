...
<Argument title='daemon' ofType='bool' defaultValue='False'>
  This should be a boolean indicating whether the thread should be a daemon thread.

  See [`threading` documentation](https://docs.python.org/3/library/threading.html#threading.Thread) for more details.
</Argument>

<Argument title='*any / **kwargs' ofType='Any / Mapping[str, Any]' defaultValue='None'>
...
<Argument title='result' ofType='Data_Out'>
...
<Argument title='status' ofType='thread.ThreadStatus'>
...
<Argument title='errors' ofType='List[Exception]'>
...
<Argument title='hooks' ofType='List[(Data_Out) -> Any | None]'>
...
<Argument title='start' ofType='() -> None'>
...
<Argument title='is_alive' ofType='() -> bool'>
...
<Argument title='add_hook' ofType='((Data_Out) -> Any | None) -> None'>
...
<Argument title='get_return_value' ofType='() -> Data_Out'>
...
<Argument title='join' ofType='(timeout: float = None) -> bool'>
...
<Argument title='kill' ofType='(yielding: bool = False, timeout: float = 5) -> bool'>
