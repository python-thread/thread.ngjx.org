...
<details>
  ...
  <ul>
    ...
    <li><Link href='#initializing-a-thread'> Initialize a thread </Link></li>
    <li><Link href='#parameters'> Parameters </Link></li>
    <li><Link href='#attributes'> Attributes </Link></li>
    <li><Link href='#methods'> Class Methods </Link></li>
    <li><Link href='#behaviours'> Behaviours </Link></li>
  </ul>
</details>
