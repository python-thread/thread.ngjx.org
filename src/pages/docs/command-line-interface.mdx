...
<details>
  ...
  <ul>
    ...
    <li><Link href='#log-levels'> Log Levels </Link></li>
    <li><Link href='#commands'> Commands </Link></li>
    <details>
      <summary>List</summary>
      <ul>
        <li><Link href='#documentation-thread-docs'> thread docs </Link></li>
        <li><Link href='#help-thread-help'> thread help </Link></li>
        <li><Link href='#report-thread-report'> thread report </Link></li>
        <li><Link href='#configuration-thread-config'> thread config </Link></li>
        <li><Link href='#parallel-processing-thread-process'> thread process ... </Link></li>
      </ul>
    </details>
  </ul>
...
![Help Command Output](/cli_help.png)
...
![Process Command Help Output](/process_help.png)
